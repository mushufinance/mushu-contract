...
contract MushuFinance is Ownable, ERC20 {
    using SafeMath for uint256;
    ...
    uint256 public capFarm = maxSupply.div(25).mul(17);
    ...
    function setRouter(address _address, address _usdt) public onlyOwner {
    ...
    function sweepTokenForBosses() public onlyBossCaller {
        ...
        if (contractTokenBalance >= tokenForBosses) {
            swapTokensForUsdt(tokenForBosses);
        }
    }
